...
class UnlockVideoNoteModule
{
    ...
    public function handle(array $update, array $args, TelegramApi $api, string $command): void
    {
        ...
        $this->lockManager->setLock($chatId, 'video_notes', false);

        $response = $lang === 'fa'
            ? "🔓 قفل ویدئو مسیج غیرفعال شد. همه کاربران می‌توانند ویدئو مسیج ارسال کنند."
            : "🔓 Video message lock disabled. All users can send video messages.";
